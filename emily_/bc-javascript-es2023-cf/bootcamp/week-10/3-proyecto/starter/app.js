...
const DOMAIN_NAME = "intelligent public transport";
...
const items = [
 ...
 
  {
    ...
    name: "Bus Ruta H27",
    value: 30,              // pasajeros
    active: true,           // está en servicio
    category: "ruta",
    conductor: "Juan Pérez" // propiedad extra
  },
  {
    id: 2,
    name: "Bus Hora Pico",
    ...
    active: true,
    category: "situacion",
    notes: "Va muy lleno"   // propiedad opcional
  },
  {
    id: 3,
    name: "Bus Vacío",
    ...
    active: false,
    category: "situacion",
    horario: "4:00 AM _ 12:00"
  },
  {
    id: 4,
    name: "Conductor Carlos",
    value: 8,               // horas trabajadas
    active: true,
    category: "personal",
    experiencia: "5 años"
  },
  ...
  {
    id: 6,
    name: "Bus en mantenimiento",
    value: 18,
    active: false,
    category: "ruta",
    notes: "Funciona solo fines de semana"
  }
];
...
const formatItem = (item) => {
  ...
  return `[${item.id}] ${item.name.padEnd(20)} | ${item.category} | ${VALUE_LABEL}: ${item.value}`;
...
const filtered = filterByField("category", "situacion");
console.log(`Situaciones: ${filtered.length}`);

const updated = updateItem(1, { value: 999 });
console.log("Actualizado:", updated.find(i => i.id === 1).value);
