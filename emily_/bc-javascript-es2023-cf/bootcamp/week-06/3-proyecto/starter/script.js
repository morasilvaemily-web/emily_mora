...
const items = [
  { name: "Bus lleno en hora pico", category: "situación", value: 50 }, 
  { name:"como esta el bus a las 10 am ", category: "situacion", value : 20},
  { name: "Conductor del bus", category: "personal", value: 88 },
   { name: "pasajeros", category: "situacion", value: 30 },
   { name: "ruta h27", category: "ruta", value :75}
...
const categories = [ "personal", " situacion", "ruta"
...
const valueLabel = "pasajeros ";
" conductor del bus ";
"ruta h27";
" bus lleno en hora pico";
"como esta el bus a las 10 am "; // ← cambiar
