...
const DOMAIN_NAME = "trasporte publico ";
...
// ];
const items =  [
  { id: 1, name: "Bus Ruta 35", category: "vehiculo", value: 40, active: true },
  { id: 2, name: "Bus Ruta Centro", category: "vehiculo", value: 30, active: true },
  { id: 3, name: "Paradero Central", category: "infraestructura", value: 20, active: true },
  { id: 4, name: "Conductor turno mañana", category: "personal", value: 1, active: true },
  { id: 5, name: "Bus en mantenimiento", category: "vehiculo", value: 0, active: false }
];
...
const formatItem = (item) => {return `🚍 ${item.name} — ${item.category} — ${VALUE_LABEL}: ${item.value}`;
...
//
// Ejemplo (Farmacia): calcular totn  al de compra con descuento
