...
const DOMAIN_NAME = "Sistema de Transporte Público Inteligente";
...
const rawEntityName = "   Transporte Público Inteligente  ";

// TODO: Define una categoría o tipo (string)
const entityCategory = "veiculo de trasporte publico ";

// TODO: Define un código identificador (string)
// Elige un prefijo coherente con tu dominio
const entityCode = "ro-001";

// TODO: Define una descripción corta (string)
// Debe contener varias palabras para usar includes/slice
const entityDescription = "Vehículo del sistema de transporte público inteligente que mejora la movilidad urbana de las personas ";
...
const descriptionIsRelevant = entityDescription.includes("sistema de trasporete publiuco  inteligente ");
...
console.log(`¿Descripción contiene el trasporte publico ?: ${descriptionIsRelevant}`);
