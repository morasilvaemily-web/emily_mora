...
console.log('BUSES MUNICIPALES');
console.log('SISTEMA DE TRANSPORTE INTELIGENTE');
...
console.log('Nombre:          Bus Ruta 35');
console.log('Código:          BUS-H35');
console.log('Categoría:       Transporte público urbano');
...
console.log('Nombre:          Bus Ruta 15');
console.log('Código:          BUS-015');
console.log('Categoría:       Transporte público urbano');
console.log('Estado:          Activo');
...
console.log('Valor principal:    [50]');
...
console.log('Valor calculado:    ', 50 - 15);
...
console.log('¡Sistema de buses en funcionamiento!');
