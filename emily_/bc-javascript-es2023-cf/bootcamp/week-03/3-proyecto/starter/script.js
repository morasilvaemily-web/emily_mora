...
const cantidaddeBusesurbanos = 20;
 const totaldeBuses = cantidaddeBusesintermunicipales + cantidaddeBusesurbanos;
...
console.log("porcentaje de ganancia:", porcentajedeganancia + "%");
...
console.log("¿el bus esta lleno?", buslleno);
