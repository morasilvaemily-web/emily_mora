...
const DOMAIN_NAME = "sistema de trasporte inteligente ";
...
const itemName = "organizacion de buses ";
...
const itemQuantity = 50; // reemplaza 0 con el número adecuado
...
const isBusEnServicio = true;
const hasPasajeros = true;// reemplaza con algo de tu dominio
...
const conductorAsignado = null;
const horarioSalida = null; // cambia el nombre a algo de tu dominio
...
console.log("typeof isBusEnServicio: ", typeof isBusEnServicio);
console.log("");
...
console.log("typeof isBusEnServicio: ", typeof isBusEnServicio);
console.log("typeof hasPasajeros: ", typeof hasPasajeros);
console.log("typeof conductorAsignado: ", typeof conductorAsignado);
...
const cantidadTexto = String(itemQuantity);
console.log("Cantidad como texto:", cantidadTexto);
console.log("typeof (convertido):", typeof cantidadTexto);
...
console.log("Valor pendiente:", conductorAsignado);
console.log("typeof null:", typeof conductorAsignado);
console.log("¿Es null?:", conductorAsignado === null);
